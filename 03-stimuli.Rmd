...
```{block, type = "warning"}
GIMP keeps crashing on me when I try to use the text tool. I'll need to access another computer to create this image.
```
...
- The second is 50% quality and has minimal pixelation artifacts around the periphery of the face, neck, hair and some issues with the skin texture in places. It also seems (to my office mates and I at least) that the skin tone is a little yellower in image 2, likely a result of a reduction in the available colour palette. 
