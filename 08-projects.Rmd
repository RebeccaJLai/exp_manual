...
By copying the "Test" URL and sending it to testers, they will be able to access your project (including non-acitvated sections) for testing.
...
- "**exp.psy.gla.ac.uk/project&myurl&test**" will present the user with the tst login dialogue box:
