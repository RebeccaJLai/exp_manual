...
```{block, type = "warning"} 
Supervisors should have a researcher account if they intend for their students to use this system.

Supervision duties in this system should not be passed to another member of staff so that you can avoid registering. Admins will not accept any of the duties of the supervisor. 
