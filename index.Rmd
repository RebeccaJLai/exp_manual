...
You should also check the [known issues](#knownissues) page to determine if your problem is already known and how to fix/work around it.
...
Access to the researcher areas of the site now require on campus access. 
...
If you have affiliate status with the University of Glasgow, you should be able to use these credentials to log in to the VPN.
