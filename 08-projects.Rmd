...
In order for participants to access your study you will need to provide them with a URL (a web link/address).

Each URL needs to be unique. For Experimentum, URLs usually follow a set pattern (where XXXXX is a suffix that you assign to your project):

<center>**exp.psy.gla.ac.ukproject?XXXXX**</center>

This suffix is set in the project information page:
...
```{block, type = "info"}
This URL will be what you share with potential participants. 
...
You can see how to do this and interpret the output in the [testing your study](#sample_order) section of the sets page.
