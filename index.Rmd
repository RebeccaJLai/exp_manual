...
If you download and use the code for this online psychology study platform you should establish clear guidelines outlining the role of the admins and methods of support. 
...
If you find an issue with the Experimentum codebase, please file an issue [here](https://github.com/debruine/experimentum/issues). If you find an issue with the codebase for this manual you can file an issue [here](https://github.com/RebeccaJLai/exp_manual/issues).
