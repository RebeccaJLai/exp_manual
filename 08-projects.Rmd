...
- **requires account**: participants will be required to sign in to a registered account before they can proceed to the study.
- **ending in "&guest"**: this will take the participant to the project first page with a button to log them in as a guest.
- **ending in "&auto"**: this will automatically log the user in as a guest and display the dialogue box asking for age and gender identity information.
- **ending in "&all"**: will display 3 buttons asking the user to choose between logging in to an existing account, registering for an account and logging in as a guest.
...
### Participation Credits {#credits}
 ...
 From 5th October 2020 participants will be able to recieve participation credits automatically, provided that you have:
...
Please ensure that you have adequate participation credits to cover the amount of participation that you expect to recieve. If you require further participation credits to be assigned to your account please speak to your supervisor.
 
When credits are allocated they will be issued in the name of the project from the subject pool:
